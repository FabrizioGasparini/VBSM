...
import { getTeamById, teamsData } from "@/lib/teams-data"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="lg:col-span-2 h-fit ">
              <img
                src={"/images/2025-26/squadre/" + team.id + "/squadra.png" || "/placeholder.svg"}
          ...
          <Tabs defaultValue="giocatori" className="w-full">
                    ...
                    <CardHeader className="pb-0">
                      <div className="flex items-center space-x-4">
                        <Avatar className="h-12 w-12">
                          <AvatarImage src={giocatore.id || "/placeholder.png"} />
            ...
            <TabsContent value="staff" className="mt-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {team.coaches.map((membro) => (
                  <Card key={membro.id} className="hover:shadow-lg transition-shadow">
                    <CardHeader>
                      <div className="flex items-center space-x-4">
                        <Avatar className="h-16 w-16">
                          <AvatarImage src={"/images/2025-26/squadre/" + team.id + "/" + membro.nome[0] + membro.cognome[0] + ".png" || "/placeholder.svg"} />
